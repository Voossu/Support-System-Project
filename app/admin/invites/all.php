...
$invites = Invites::get_invites_page($count, $page);
...
foreach($invites as $invite) {
    ...
    $invites_page[] = [
        ...
        'enable_url' => empty($invite['invite_reg_user'])
            ...
            : "",
        'delete_url' => HOME_URL."invites/{$invite['invite_id']}/delete?goto=".HOME_URL."invites/all/{$count}/{$page}"
    ];
}

$page_count = Invites::get_invites_page_count($count);
...
View::render("page", [
    ...
    'content' => View::render("menu", [
        ...
        'content' => View::render("admin/invites/all", [
            'new' => [
